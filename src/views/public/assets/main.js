	...
	// 載入並繪製 network
		...
		fetch(`api/${currentSumMode}`, {
			...
			.then((json) => {
				...
				const [labels, ranks, rValues, avgValues] = drawDualAxisLineChart("chart-line-2", nodes, "r_score", "avg");
				const [, admissionRates, admissionRateCounts] = drawLineChart("chart-line-1", nodes, "錄取率", "admissionrate");
